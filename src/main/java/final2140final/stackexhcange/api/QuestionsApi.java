...
public class QuestionsApi {
	...
	// API
		...
		public final String makeGetAnswerURI(String questionId, String site) throws URIException{
			String originalUriString = "https://api.stackexchange.com/questions/"+questionId+"/answers?order=desc&sort=activity&site="+site+"&filter=!4*Zo7YZsxr6*fr_99";
			return URIUtil.encodeQuery(originalUriString);
		}
}
